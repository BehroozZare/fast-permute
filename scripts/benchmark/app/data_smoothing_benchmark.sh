...
# =============================================================================
# Data Smoothing Benchmark Script
# =============================================================================
...
INPUT_ROOT="${APPS_ROOT}/data_smoothing"
OUTPUT_ROOT="/home/behrooz/Desktop/Last_Project/gpu_ordering/output/Apps"
OUTPUT_CSV_BASE="${OUTPUT_ROOT}/data_smoothing"
BENCHMARK_BIN="/home/behrooz/Desktop/Last_Project/gpu_ordering/cmake-build-release/benchmark/multiple_factorization/gpu_ordering_data_smoothing_benchmark"
...
if [[ ${#MESHES[@]} -eq 0 ]]; then
    echo "No data_smoothing .obj files found under ${INPUT_ROOT}"
    exit 1
fi

echo "Found ${#MESHES[@]} data_smoothing datasets."
...
echo "Data smoothing benchmark complete. CSVs are in ${OUTPUT_ROOT}"
